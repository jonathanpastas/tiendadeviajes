...
String table=cls.verHistorial(cedu);
String name=cls.Nombre_Cliente(cedu);
%>

<div class="container">
<h2 id="Administra">Agencia de Viajes RIKSISHAY</h2>
<h1 id="Administra">Historial de Facturas</h1>

<b>Cedula del Cliente: <%=cedu %> </b><br>
<b>Nombre del Cliente : <%=name %></b>
 <p align="right"> <a class="btn btn-outline-success" href="consulta_ventas.jsp" role="button">Regresar al Menú</a></p>
